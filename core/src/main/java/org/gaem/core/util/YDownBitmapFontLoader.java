...
public class YDownBitmapFontLoader extends AsynchronousAssetLoader<BitmapFont, YDownBitmapFontLoader.BitmapFontParameter> {
    public YDownBitmapFontLoader (FileHandleResolver resolver) {
        super(resolver);
    }
    ...
    public Array<AssetDescriptor> getDependencies (String fileName, FileHandle file, BitmapFontParameter parameter) {
        ...
        if (parameter != null && parameter.atlasName != null) {
            ...
            for (int i = 0; i < data.getImagePaths().length; i++) {
                ...
                YDownTextureLoader.TextureParameter textureParams = new YDownTextureLoader.TextureParameter();
